...
int Payslip::PayGradeTaxRate()
    ...
    void Payslip::ComputePay()
    {
        ...
        cout << "Basic Salary : " << mBasicsalary << ".00 PHP" << endl;
        cout << "Pay Grade : " << mPaygrade << endl;
        cout << "No. of OT Hours : " << mOThours << endl;
        cout << "OT Pay : " << mOTpay << ".00 PHP"<< endl;
        cout << "Gross Pay : " << mGrosspay << ".00 PHP" << endl;
        cout << "Withholding Tax : " << mWithholdingtax << ".00 PHP" << endl;
        cout << "Net Pay : " << mNetpay << ".00 PHP"<< endl;
    }
